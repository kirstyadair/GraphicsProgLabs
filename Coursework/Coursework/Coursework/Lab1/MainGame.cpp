...
void MainGame::initSystems()
{
	...
	texture.init("..\\res\\Models\\Fish2Texture.jpg"); //load texture


	shaderSkybox.init("..\\res\\ShaderFiles\\shaderSkybox.vert", "..\\res\\ShaderFiles\\shaderSkybox.frag");
	shaderReflection.init("..\\res\\ShaderFiles\\shaderReflection.vert", "..\\res\\ShaderFiles\\shaderReflection.frag");
	shaderGeometry.initGeom("..\\res\\ShaderFiles\\shaderGeometry.vert", "..\\res\\ShaderFiles\\shaderGeometry.frag", "..\\res\\ShaderFiles\\shaderGeometry.geom");
	shaderNormals.initGeom("..\\res\\ShaderFiles\\shaderNormals.vert", "..\\res\\ShaderFiles\\shaderNormals.frag", "..\\res\\ShaderFiles\\shaderNormals.geom");

	mesh1.loadModel("..\\res\\Models\\Fish2.obj");
	mesh2.loadModel("..\\res\\Models\\Fish3.obj");
	mesh3.loadModel("..\\res\\Models\\FishRotated.obj");
